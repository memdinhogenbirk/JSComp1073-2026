...
function success(position) {
    ...
    // statusMsg.textContent = "found you";
    ...
    mapLink.href = `https://www.openstreetmap.org/#map=15/${position.coords.latitude}/${position.coords.longitude}`;
}


// STEP 4a: Construct the error() function
function error() {
    statusMsg.textContent = "Unable to retrieve your location. Please check your device settings and try again.";
}
...
if(!navigator.geolocation){
    ...
    statusMsg.textContent = "Geolocation is supported by your browser. Please allow access to your location.";
