...
function Coffee(size, isDecaf, qtyCream, qtySugar){
    ...
    this.description = function(){
        return `${this.size} ${this.qtyCream} ${this.qtySugar} ${this.decaf}`
    }
}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let coffee = new Coffee("Large", false, 2, 2);
...
const coffee2 = Object.create(coffee);
...
const coffee3 = new coffee2.constructor("small", true, 2, 2);
