async function startProgram() {
    // The actions we used in the previous block of code were METHODS - functions that are attached to an object (the robot, in this case). 
    //FUNCTIONS are standalone blocks of code that can be called from anywhere in the program. They are reusable and can take parameters to customize their behavior.
